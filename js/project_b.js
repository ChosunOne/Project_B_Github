...
function main() {
    ...
    var tick = function () {
        animate();
        draw(gl, u_ViewMatrix, viewMatrix, u_ProjMatrix, projMatrix, orthoMatrix);
...
function draw(gl, u_ViewMatrix, viewMatrix, u_ProjMatrix, projMatrix, orthoMatrix) {
    ...
    viewMatrix.setLookAt(0, 0, 10, //example was g_CamX, g_CamY, g_CamZ, this is the camera in world coords.
                         0, 0, 0,  //example was 0, 0, 0, this is the point being looked at
                         0, 1, 0); //example was 0, 1, 0, this is the up direction

    gl.uniformMatrix4fv(u_ViewMatrix, false, viewMatrix.elements);

    drawScene(gl, u_ViewMatrix, viewMatrix);
    ...
    viewMatrix.setLookAt(10, 0, 0, // was -g_CamX, g_CamY, g_CamZ
                        0, 0, 0, // was 0, 0, 0
                        0, 1, 0);
...
function drawScene(myGL, myu_ViewMatrix, myViewMatrix) {
